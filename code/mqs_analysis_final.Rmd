...
- There could be other variables which act as potential mediators or moderators such as pain medication MQS score, number of visits to the general practitioner, etc. which have not been considered in this analysis. There exists complex procedures to perform meidation analysis for multiple potential mediators [6], which can be included in the future research.
