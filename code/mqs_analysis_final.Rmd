---
title: "Analysis of the effect of pain and prophylactic medication MQS and acupuncture on headache"
...
```{r}
data$avg_mqs = (data$totalmeds5 + data$totalmeds2) / 2
...
# Checking zero-order relationship: X -> M
print("Checking zero-order relationship: X -> M")
s2_model = lm(totalmeds5 ~ acuptreatments, data=data)
summary(s2_model)
...
# Checking effect of M controlling for X
print("Checking effect of M controlling for X")
s4_model = lm(delta5 ~ totalmeds5 + acuptreatments, data=data)
summary(s4_model)

# Checking Moderation effect caused by M (interaction effect between X and M)
print("Checking Moderation effect caused by M (interaction effect between X and M)")
moderator_model = lm(delta5 ~ acuptreatments*totalmeds5, data=data)
summary(moderator_model)
```
