...
Mediation Effect Analysis was carried out as follows [1]:
...
#### Limitation:
- We have not explored how confounders could affect the mediation analysis. There are complex methods to test mediation with control variables [2].
- There could be other variables which act as potential mediators or moderators such as pain medication MQS score, number of visits to the general practitioner, etc. which have not been considered in this analysis. There exists complex procedures to perform mediation analysis for multiple potential mediators [3], which can be included in the future research.
...
#### References:
[1] Web Article - [http://web.pdx.edu/~newsomj/semclass/ho_mediation.pdf](http://web.pdx.edu/~newsomj/semclass/ho_mediation.pdf)

[2]. MacKinnon, David P., Amanda J. Fairchild, and Matthew S. Fritz. "Mediation analysis." Annu. Rev. Psychol. 58 (2007): 593-614.

[3]. VanderWeele, Tyler, and Stijn Vansteelandt. "Mediation analysis with multiple mediators." Epidemiologic methods 2.1 (2014): 95-115.
